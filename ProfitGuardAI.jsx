...
function HalalExpiryTracker({arabic}){
  ...
  const [newIng, setNewIng] = useState({
    name: "", icon: "📦", iconBg: "rgba(26,108,255,.12)",
  ...
  const handleAddIngredient = () => {
    ...
    setNewIng({ name: "", icon: "📦", iconBg: "rgba(26,108,255,.12)", batch: "", expiry: "", halal: true });
    ...
    <div className="ht-card">
      ...
      {showAddForm ? (
        <div style={{
          ...
          borderTop:".5px solid rgba(26,108,255,.2)",
          padding:"14px 16px"
        }}>
          <div style={{
...
function InstallPrompt() {
    ...
    return (
      <div style={{
        ...
        <ol style={{ paddingLeft: 22, fontSize: 12, color: "var(--text-2)", lineHeight: 1.7, margin: "8px 0 0" }}>
          ...
          <li>Open ProfitGuard from your home screen like any app</li>
        </ol>
        <button onClick={handleDismiss} style={{
  ...
  return (
    <div style={{
      ...
      background: "linear-gradient(135deg, #1a6cff, #0a4ec9)",
      border: ".5px solid rgba(255,255,255,.15)",
      borderRadius: 12, padding: "12px 14px",
      boxShadow: "0 8px 28px rgba(26,108,255,.35)",
    ...
    <div style={{ padding: "20px 18px 100px", maxWidth: 480, margin: "0 auto" }}>
      ...
      <div style={{
        ...
        <div style={{
          ...
          background: csvImport ? "rgba(0,184,107,.06)" : "rgba(26,108,255,.04)",
          border: ".5px dashed " + (csvImport ? "rgba(0,184,107,.35)" : "rgba(26,108,255,.3)"),
          borderRadius: 10
        }}>
          <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
            <div style={{
        ...
        {allItems.map((item) => {
          ...
          return (
            <div key={item.id} style={{
              ...
              borderRadius: 10,
              border: ".5px solid " + (isExpanded ? "rgba(26,108,255,.35)" : "var(--border)"),
              marginBottom: 7,
              overflow: "hidden",
                  ...
                  <div style={{ display: "flex", alignItems: "center", gap: 6 }}>
                    ...
                    {recipe.cup_size && recipe.cup_size !== "-" && (
                      <span style={{
                        ...
                        background: "rgba(26,108,255,.12)", padding: "2px 6px",
                ...
                <div style={{
                  ...
                  <button
                    ...
                    style={{
                      ...
                      border: ".5px dashed rgba(26,108,255,.4)",
