  ...
  return (
    <div className="auth-shell fade-in">
      <div className="auth-logo">
        <img src="/kaffelog-icon.png" alt="Kaffelog" style={{width:42,height:42,objectFit:"contain"}} />
        <img src="/kaffelog-wordmark.png" alt="Kaffelog" style={{height:24,objectFit:"contain"}} />
      </div>
            ...
            <div style={{display:"flex",alignItems:"center",justifyContent:"space-between",marginBottom:"22px"}}>
              <div>
                <div className="pg-wordmark">
                  <img src="/kaffelog-icon.png" alt="Kaffelog" style={{width:30,height:30,objectFit:"contain"}} />
                  <img src="/kaffelog-wordmark.png" alt="Kaffelog" style={{height:18,objectFit:"contain"}} />
                </div>
