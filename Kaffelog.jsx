      ...
      <div style={{padding:"14px 18px",display:"flex",flexDirection:"column",gap:"8px"}}>
        <div style={{display:"flex",justifyContent:"space-between",alignItems:"center"}}>
          ...
          <button onClick={() => setShowAddStaff(true)} style={{
            background:"rgba(10,135,84,.12)",color:"#7aadff",
    ...
    <div className="ht-card">
      ...
      {showAddForm ? (
        <div style={{
          ...
          <div style={{
            fontSize:11,fontWeight:600,color:"#7aadff",marginBottom:10,
            letterSpacing:".06em",textTransform:"uppercase",
  ...
  return(
    <div className="sup-card">
      <div className="sup-hd">
        ...
        <div style={{display:"flex",alignItems:"center",gap:"5px",background:"rgba(10,135,84,.1)",border:".5px solid rgba(10,135,84,.22)",borderRadius:"20px",padding:"4px 9px",fontSize:"9px",fontWeight:"700",color:"#7aadff",letterSpacing:".06em",textTransform:"uppercase",flexShrink:0}}>
...
function InstallPrompt() {
  ...
  if (showIOSInstructions) {
    return (
      <div style={{
        ...
        background: "#0b1829", borderTop: ".5px solid var(--blue)",
        padding: "16px 18px 22px", boxShadow: "0 -8px 24px rgba(0,0,0,.5)"
      }}>
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: 10 }}>
          <div style={{ fontFamily: "var(--font-d)", fontSize: 14, fontWeight: 700, color: "var(--text-1)" }}>
        ...
        <ol style={{ paddingLeft: 22, fontSize: 12, color: "var(--text-2)", lineHeight: 1.7, margin: "8px 0 0" }}>
          <li>Tap the <strong style={{ color: "var(--text-1)" }}>Share</strong> icon at the bottom (square with up-arrow)</li>
          <li>Scroll down, tap <strong style={{ color: "var(--text-1)" }}>"Add to Home Screen"</strong></li>
          <li>Tap <strong style={{ color: "var(--text-1)" }}>"Add"</strong> in the top right</li>
          <li>Open Kaffelog from your home screen like any app</li>
        </ol>
        <button onClick={handleDismiss} style={{
          marginTop: 14, width: "100%", padding: "10px 0",
          background: "rgba(255,255,255,.05)", color: "var(--text-2)",
          border: ".5px solid var(--border)", borderRadius: 8,
          fontSize: 11, fontWeight: 600, cursor: "pointer",
          fontFamily: "var(--font-d)", letterSpacing: ".06em", textTransform: "uppercase"
        }}>Got it</button>
      </div>
    );
  }
  ...
  return (
    <div style={{
      ...
      background: "linear-gradient(135deg, #0a8754, #076b41)",
      border: ".5px solid rgba(255,255,255,.15)",
      borderRadius: 12, padding: "12px 14px",
      boxShadow: "0 8px 28px rgba(10,135,84,.35)",
      ...
      <div style={{ flex: 1, minWidth: 0 }}>
        ...
        <div style={{ fontSize: 11, color: "rgba(255,255,255,.8)", lineHeight: 1.35 }}>
      ...
      <button onClick={handleInstall} style={{
        ...
        letterSpacing: ".06em", textTransform: "uppercase",
        cursor: "pointer", fontFamily: "var(--font-d)", flexShrink: 0
      }}>Install</button>
      <button onClick={handleDismiss} style={{
...
function NotificationSetup({ onDone }) {
  ...
  return (
    <div style={{
      background: "linear-gradient(135deg, rgba(10,135,84,.12), rgba(10,135,84,.04))",
      border: ".5px solid rgba(10,135,84,.3)",
      ...
      <div style={{
        ...
        background: "rgba(10,135,84,.15)", border: ".5px solid rgba(10,135,84,.3)",
        display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0
      }}>
              ...
              {isExpanded && (
                <div style={{
                  ...
                  <div style={{
                    ...
                    textTransform: "uppercase", color: "#7aadff", marginBottom: 8,
                    display: "flex", alignItems: "center", gap: 6
                  }}>
                  ...
                  <button
                    ...
                    style={{
                      ...
                      background: "transparent", color: "#7aadff",
        ...
        {!showAddItem ? (
          <button
            ...
            style={{
              ...
              background: "rgba(10,135,84,.06)", color: "#7aadff",
            ...
            <div key={log.id} style={{
              ...
              <div style={{display:"flex",justifyContent:"space-between",alignItems:"flex-start",marginBottom:8}}>
                ...
                <button
                  ...
                  style={{
                    background:"rgba(10,135,84,.1)",color:"#7aadff",
    ...
    <div className="auth-shell fade-in">
      <div className="auth-logo">
        <div className="auth-logo-mark">
          <svg width="20" height="20" viewBox="0 0 20 20" fill="none"><path d="M10 3v14M3 7h14M5 7l-1.5 4a2.5 2.5 0 005 0L7 7M15 7l-1.5 4a2.5 2.5 0 005 0L17 7" stroke="#fff" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/></svg>
        </div>
        <span className="auth-brand">Kaffelog</span>
      </div>
      <div className="auth-tagline">Smart logs for UAE cafés</div>
            ...
            <div style={{display:"flex",alignItems:"center",justifyContent:"space-between",marginBottom:"22px"}}>
              <div>
                <div className="pg-wordmark">
                  <div className="pg-logo"><svg width="16" height="16" viewBox="0 0 20 20" fill="none"><path d="M10 3v14M3 7h14M5 7l-1.5 4a2.5 2.5 0 005 0L7 7M15 7l-1.5 4a2.5 2.5 0 005 0L17 7" stroke="#fff" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/></svg></div>
                  <span className="pg-brand">Kaffelog</span>
                </div>
